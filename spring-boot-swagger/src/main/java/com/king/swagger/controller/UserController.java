package com.king.swagger.controller;

import com.king.swagger.model.Car;
import com.king.swagger.model.DataNode;
import com.king.swagger.model.User;
import com.king.swagger.model.UserCondition;
...
public class UserController {
    ...
    @ApiOperation(value = "根据用户ID查询用户信息", notes = "根据url的id来获取用 户详细信息")
